function output = ERBFilterBankA(x, cF, Fs)
% function output = ERBFilterBankA(x, cF, Fs)
...
% argins:
%   x = input sound
%   cF = vector of center frequencies
...
if nargin < 1
	error('Syntax: output_array = ERBFilterBankA(x, cF, Fs);');
end

if nargin < 3   Fs = 30000;	end

if nargin < 2	cF = [2000:1000:10000];	end
