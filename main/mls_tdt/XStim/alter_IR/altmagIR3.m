function [IRout, IRin] = altmagIR3 (IRin, minF, maxF, Fact)
...
if nargin < 4		Fact = 20;	    end
if nargin < 3		maxF = 8000;	else maxF = sort(maxF(:));    end
if nargin < 2		minF = 5000;	else minF = sort(minF(:));    end
...
if pflag
    ...
    title('black: FT new (modified)       blue: FT IRshort (non-zero)           red: FT new2 (after ifft & fft of FT new)') 
