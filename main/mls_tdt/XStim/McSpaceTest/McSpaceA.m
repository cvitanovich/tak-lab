% McSpace: the GUI for Space tests using stimuli simuliar to Dean and
% McAlpine's
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.spacefilepb = uicontrol('Parent',H.mcSpacefig,...
   'Style','pushbutton',...
   'Units','pixels',...
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.spacefilehdr = uicontrol('Parent',H.mcSpacefig,...
   'Style','text',...
   'Position',[0 F.space_ht-F.tot_ht 120 F.ind_ht],...
   'String', 'Fully-cued HRTF File:');
H.spacefile = uicontrol('Parent',H.mcSpacefig,...
   'Style','text',...
...
H.mcSpace_rampptstxt(2) = uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[160 F.space_ht-F.tot_ht 230 80],...
   'BackgroundColor',[.8 .8 .8], ...
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.Spacetestmod_txtC = uicontrol(        'Style','text',...
    'Units','pixels',...
