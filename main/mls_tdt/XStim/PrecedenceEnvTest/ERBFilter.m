function [filteredSnd, fcoefs] = ERBFilter(fs, Freq, Snd)
	...
	filteredSnd = filter([A0(chan)/gain(chan) A11(chan)/gain(chan) ...
		A2(chan)/gain(chan)],[B0(chan) B1(chan) B2(chan)], Snd);
	filteredSnd = filter([A0(chan) A12(chan) A2(chan)], ...
			[B0(chan) B1(chan) B2(chan)], filteredSnd);
	filteredSnd = filter([A0(chan) A13(chan) A2(chan)], ...
			[B0(chan) B1(chan) B2(chan)], filteredSnd);
	filteredSnd = filter([A0(chan) A14(chan) A2(chan)], ...
			[B0(chan) B1(chan) B2(chan)], filteredSnd);
