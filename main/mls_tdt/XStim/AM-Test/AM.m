...
uicontrol('Style','text',...
   ...
   'FontSize',12,...
   'FontWeight','bold',...
   'String', 'HRIRs in DSPs: use *.std HRIRs');
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.spacefilepb = uicontrol('Parent',H.AM_fig,...
   'Style','pushbutton',...
   'Units','pixels',...
...
H.spaceflag = uicontrol('Parent',H.AM_fig,...
   ...
   'Callback','setinfo_AM');
F.tot_ht = F.tot_ht + F.ind_ht;
H.spacefilehdr = uicontrol('Parent',H.AM_fig,...
   'Style','text',...
   'Position',[0 F.space_ht-F.tot_ht 120 F.ind_ht],...
   'String', 'Fully-Cued File:');
H.spacefile = uicontrol('Parent',H.AM_fig,...
   'Style','text',...
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.ildalonepb = uicontrol('Parent',H.AM_fig,...
   'Style','pushbutton',...
   'Units','pixels',...
   'Position',[2 F.space_ht-F.tot_ht 195 F.ind_ht],...
   'BackgroundColor','red',...
...
H.ildaloneflag = uicontrol('Parent',H.AM_fig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[315 F.space_ht-F.tot_ht 30 F.ind_ht],...
   ...
   'Callback','setinfo_AM');
F.tot_ht = F.tot_ht + F.ind_ht;
H.ildalonefilehdr = uicontrol('Parent',H.AM_fig,...
   'Style','text',...
   'Position',[0 F.space_ht-F.tot_ht 120 F.ind_ht],...
   'String', 'ILDAlone File:');
H.ildalonefile = uicontrol('Parent',H.AM_fig,...
   'Style','text',...
   'Position',[120 F.space_ht-F.tot_ht F.space_wd-120 F.ind_ht],...
   'HorizontalAlignment','left',...
   'ForegroundColor','blue',...
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.itdalonepb = uicontrol('Parent',H.AM_fig,...
   'Style','pushbutton',...
   'Units','pixels',...
   'Position',[2 F.space_ht-F.tot_ht 195 F.ind_ht],...
   'BackgroundColor','red',...
...
H.itdaloneflag = uicontrol('Parent',H.AM_fig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[315 F.space_ht-F.tot_ht 30 F.ind_ht],...
   ...
   'Callback','setInfo_AM');
F.tot_ht = F.tot_ht + F.ind_ht;
H.itdalonefilehdr = uicontrol('Parent',H.AM_fig,...
   'Style','text',...
   'Position',[0 F.space_ht-F.tot_ht 100 F.ind_ht],...
   'String', 'ITDAlone File:');
H.itdalonefile = uicontrol('Parent',H.AM_fig,...
   'Style','text',...
...
H.space3_stim_type = uicontrol('Parent',H.AM_fig,...
   'Style','popup',...
   'Units','pixels',...
   'Position',[112 F.space_ht-F.tot_ht 110 F.ind_ht],...
   'BackgroundColor','white',...
   'String',...
   'Tone|Gammatone|Tone Stack|GammaTone Stack|BandPassed Noise|NarrowBand Noise|NarrowBand Noise Stack|BroadBand Noise|File|None|Complex',...
   'Value',get(H.stim_type,'Value'),...
   'Callback','setinfo_AM');

% allow re-choice of stimulus filename
H.space3_stimFNpb = uicontrol('Parent',H.AM_fig,...
   'Style','pushbutton',...
   'Units','pixels',...
   ...
   'String', 'FN',...
   'Callback','setinfo_AM');
H.space3_stimFN = uicontrol('Parent',H.AM_fig,...
   'Style','text',...
   'Units','pixels',...
   'ForegroundColor','blue',...
...
% set number of segments and subreps and then push the button to edit them
H.space3_stim_seg_pb = uicontrol('Parent',H.AM_fig,...
   'Style','pushbutton',...
   'Units','pixels',...
   'Position',[224 F.space_ht-F.tot_ht 80 F.ind_ht],...
   'BackgroundColor','red',...
   'ForegroundColor','white',...
   'FontWeight','bold',...
   'String', 'Edit Complex',...
   'Callback', 'setinfo_AM');
H.com_len_ted_txt = uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[306 F.space_ht-F.tot_ht 40 F.ind_ht],...
   'String', 'Seg #:');
H.com_len_ted = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[348 F.space_ht-F.tot_ht 40 F.ind_ht],...
   'String', num2str(XStimParams.com_len_ted));
H.com_len_ted_txt2 = uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[390 F.space_ht-F.tot_ht 40 F.ind_ht],...
   'String', 'Subr #:');
H.com_num_ted = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[432 F.space_ht-F.tot_ht 40 F.ind_ht],...
   'String', num2str(XStimParams.com_num_ted));
