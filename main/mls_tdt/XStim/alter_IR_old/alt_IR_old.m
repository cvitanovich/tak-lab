...
H.spacefilehdr = uicontrol('Parent',H.altIRfig,...
   'Style','text',...
   'Position',[0 fig_ht-F.tot_ht 120 F.ind_ht],...
   'String', 'Fully-cued HRTF File:');
H.spacefile = uicontrol('Parent',H.altIRfig,...
   'Style','text',...
   'Position',[120 fig_ht-F.tot_ht fig_wd-120 F.ind_ht],...
...
H.spacefilepb = uicontrol('Parent',H.altIRfig,...
   'Style','pushbutton',...
   'Units','pixels',...
   'Position',[2 fig_ht-F.tot_ht 195 F.ind_ht],...
   'BackgroundColor','red',...
   'ForegroundColor','white',...
   'FontWeight','bold',...
...
uicontrol('Parent',H.altIRfig,...
   'Style','text',...
   'Units','pixels',...
   'Position',[200 fig_ht-F.tot_ht 110 F.ind_ht],...
   'String', 'Fully-cued Test');
H.spaceflag = uicontrol('Parent',H.altIRfig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[315 fig_ht-F.tot_ht 30 F.ind_ht],...
...
uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[0 F.altIR_ht-F.tot_ht 130 F.ind_ht],...
   'String', 'Alter Impulse Responses:');
uicontrol('Parent',H.altIRfig,...
   'Style','text',...
   'Units','pixels',...
   'Position',[130 fig_ht-F.tot_ht 60 F.ind_ht],...
   'String', 'left IR');
H.alter_left = uicontrol('Parent',H.altIRfig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[190 fig_ht-F.tot_ht 20 F.ind_ht],...
   'Value',XStimParams.alter_left,...
   'Callback','setInfo_altIR');
uicontrol('Parent',H.altIRfig,...
   'Style','text',...
   'Units','pixels',...
   'Position',[210 fig_ht-F.tot_ht 60 F.ind_ht],...
   'String', 'right IR');
H.alter_right = uicontrol('Parent',H.altIRfig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[270 fig_ht-F.tot_ht 20 F.ind_ht],...
...
uicontrol('Parent',H.altIRfig,...
   'Style','text',...
   'Units','pixels',...
   'Position',[0 fig_ht-F.tot_ht 80 F.ind_ht],...
   'String', 'magnitude');
H.alterMag = uicontrol('Parent',H.altIRfig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[80 fig_ht-F.tot_ht 30 F.ind_ht],...
   'Value',XStimParams.alterMag,...
   'Callback','setInfo_altIR');

uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[110 F.altIR_ht-F.tot_ht 60 F.ind_ht],...
   'String', 'Bandlimits');
H.alterMag_Minbandlimits(1) = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[170 F.altIR_ht-F.tot_ht 70 F.ind_ht],...
   'BackgroundColor','white',...
   'String',XStimParams.alterMag_Minbandlimits(1),...
   'Callback','setInfo_altIR');
H.alterMag_Maxbandlimits(1) = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[240 F.altIR_ht-F.tot_ht 70 F.ind_ht],...
   'BackgroundColor','white',...
   'String',XStimParams.alterMag_Maxbandlimits(1),...
   'Callback','setInfo_altIR');
uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[310 F.altIR_ht-F.tot_ht 40 F.ind_ht],...
   'String', 'dB');
H.alterMag_dB = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[350 F.altIR_ht-F.tot_ht 50 F.ind_ht],...
   'BackgroundColor','white',...
...
for i = 2:3
  F.tot_ht = F.tot_ht + F.ind_ht;
  H.alterMag_Minbandlimits(i) = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[170 F.altIR_ht-F.tot_ht 70 F.ind_ht],...
   'BackgroundColor','white',...
   'Callback','setInfo_altIR');
  if length(XStimParams.alterMag_Minbandlimits) >= i
    set(H.alterMag_Minbandlimits(i),'String',XStimParams.alterMag_Minbandlimits(i));
  end
  H.alterMag_Maxbandlimits(i) = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[240 F.altIR_ht-F.tot_ht 70 F.ind_ht],...
   'BackgroundColor','white',...
   'Callback','setInfo_altIR');
  if length(XStimParams.alterMag_Maxbandlimits) >= i
    set(H.alterMag_Maxbandlimits(i),'String',XStimParams.alterMag_Maxbandlimits(i));
  end
end
...
H.alterPhase_Minbandlimits(1) = uicontrol('Style','edit',...
   ...
   'Position',[170 F.altIR_ht-F.tot_ht 70 F.ind_ht],...
   'BackgroundColor','white',...
   'String',XStimParams.alterPhase_Minbandlimits(1),...
   'Callback','setInfo_altIR');
H.alterPhase_Maxbandlimits(1) = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[240 F.altIR_ht-F.tot_ht 70 F.ind_ht],...
   'BackgroundColor','white',...
   'String',XStimParams.alterPhase_Maxbandlimits(1),...
   'Callback','setInfo_altIR');
uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[310 F.altIR_ht-F.tot_ht 40 F.ind_ht],...
...
for i = 2:3
  F.tot_ht = F.tot_ht + F.ind_ht;
  H.alterPhase_Minbandlimits(i) = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[170 F.altIR_ht-F.tot_ht 70 F.ind_ht],...
   'BackgroundColor','white',...
   'Callback','setInfo_altIR');
  if length(XStimParams.alterPhase_Minbandlimits) >= i
    set(H.alterPhase_Minbandlimits(i),'String',XStimParams.alterPhase_Minbandlimits(i));
  end
  H.alterPhase_Maxbandlimits(i) = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[240 F.altIR_ht-F.tot_ht 70 F.ind_ht],...
   'BackgroundColor','white',...
   'Callback','setInfo_altIR');
  if length(XStimParams.alterPhase_Maxbandlimits) >= i
    set(H.alterPhase_Maxbandlimits(i),'String',XStimParams.alterPhase_Maxbandlimits(i));
  end
end
