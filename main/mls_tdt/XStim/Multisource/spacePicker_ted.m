...
H.add_point1 = uicontrol('Parent',H.pickerfig, ...
    'Style','pushbutton',...
    'Units','pixels', ...
    ...
    'String','add pts', ...
    'Callback','SetInfo_spacePicker_ted;');
H.delete_point1 = uicontrol('Parent',H.pickerfig, ...
    'Style','pushbutton',...
    'Units','pixels', ...
...
H.falling_diagonal = uicontrol('Parent',H.pickerfig, ...
    'Style','pushbutton',...
	'Units','pixels', ...
...
H.rising_diagonal = uicontrol('Parent',H.pickerfig, ...
    'Style','pushbutton',...
	'Units','pixels', ...
...
% define axes
h1 = axes('Parent',H.pickerfig, ...
	'Units','pixels', ...
	'ButtonDownFcn','spaceaxisX2CB_ted', ...
...
% all button
H.AllSpace = uicontrol('Parent',H.pickerfig, ...
	'Units','pixels', ...
...
% clear button
H.clear = uicontrol('Parent',H.pickerfig, ...
	'Units','pixels', ...
	'BackgroundColor',[0.75 0.75 0.75], ...
	'ListboxTop',0, ...
...
H.resolution = uicontrol('Parent',H.pickerfig, ...
   ...
   'Position',[284 52 70 18], ...
	'String',['Maximum       ';'10 deg. offset';'10 deg.       ';'20 deg. offset';'20 deg.       '], ...
	'Style','popupmenu', ...
    'Value', val, ...
   	'Callback','SetInfo_spacePicker_ted;');
