...
%Directories & files
cache_directory = ['d:\mlspezio\matlab\scripts\physiol_analysis\'
num2str(bird_number) 'analysis\' ...
...
for cell_num = begin_cells:end_cells
   ...
   %Get those locations in the ILDmatrix that match the measured ILDAlone
locations
