...
%   to accomodate this, each run of the program starts with a blank-stim run
%   that will play out the glitch before the true stims are played
...
if(~exist1('H.searchfig') &...
   ...
   F.space_wd = 400; 
   F.space_ht = 900;
   H.space2fig = figure('Units','pixels',...
...
uicontrol('Style','text',...
   ...
   'FontSize',12,...
   'FontWeight','bold',...
   'String', 'Stimuli NOT written to disk.');
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.spacefilepb = uicontrol('Parent',H.space2fig,...
   'Style','pushbutton',...
   'Units','pixels',...
   ...
   'Callback','setInfo_space2');
uicontrol('Parent',H.space2fig,...
   'Style','text',...
   'Units','pixels',...
   'Position',[200 F.space_ht-F.tot_ht 120 F.ind_ht],...
   'String', 'Fully-cued Test');
H.spaceflag = uicontrol('Parent',H.space2fig,...
   'Style','checkbox',...
   'Units','pixels',...
   ...
   'Callback','setInfo_space2');
F.tot_ht = F.tot_ht + F.ind_ht;
H.spacefilehdr = uicontrol('Parent',H.space2fig,...
   'Style','text',...
   'Position',[0 F.space_ht-F.tot_ht 120 F.ind_ht],...
   'String', 'Fully-cued HRTF File:');
H.spacefile = uicontrol('Parent',H.space2fig,...
   'Style','text',...
...
H.space2_ABLaloneflag = uicontrol('Parent',H.space2fig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[315 F.space_ht-F.tot_ht 30 F.ind_ht],...
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.space2_ildalonepb = uicontrol('Parent',H.space2fig,...
   'Style','pushbutton',...
   'Units','pixels',...
   'Position',[2 F.space_ht-F.tot_ht 195 F.ind_ht],...
   'BackgroundColor','red',...
...
H.space2_ildaloneflag = uicontrol('Parent',H.space2fig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[315 F.space_ht-F.tot_ht 30 F.ind_ht],...
   ...
   'Callback','setInfo_space2');
F.tot_ht = F.tot_ht + F.ind_ht;
H.space2_ildalonefilehdr = uicontrol('Parent',H.space2fig,...
   'Style','text',...
   'Position',[0 F.space_ht-F.tot_ht 100 F.ind_ht],...
   'String', 'ILD-alone File:');
H.space2_ildalonefile = uicontrol('Parent',H.space2fig,...
   'Style','text',...
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.space2_itdalonepb = uicontrol('Parent',H.space2fig,...
   'Style','pushbutton',...
   'Units','pixels',...
   'Position',[2 F.space_ht-F.tot_ht 195 F.ind_ht],...
   'BackgroundColor','red',...
...
H.space2_itdaloneflag = uicontrol('Parent',H.space2fig,...
   'Style','checkbox',...
   'Units','pixels',...
   'Position',[315 F.space_ht-F.tot_ht 30 F.ind_ht],...
   ...
   'Callback','setInfo_space2');
F.tot_ht = F.tot_ht + F.ind_ht;
H.space2_itdalonefilehdr = uicontrol('Parent',H.space2fig,...
   'Style','text',...
   'Position',[0 F.space_ht-F.tot_ht 100 F.ind_ht],...
   'String', 'ITD-alone File:');
H.space2_itdalonefile = uicontrol('Parent',H.space2fig,...
   'Style','text',...
   'Position',[100 F.space_ht-F.tot_ht F.space_wd-100 F.ind_ht],...
   'HorizontalAlignment','left',...
   'ForegroundColor','blue',...
...
H.space2_stim_type = uicontrol('Parent',H.space2fig,...
   'Style','popup',...
   'Units','pixels',...
...
H.space2_stimFNpb = uicontrol('Style','pushbutton',...
   'Units','pixels',...
...
H.space2_stimFN = uicontrol('Parent',H.space2fig,...
   	'Style','text',...
   	'Units','pixels',...
...
% curr_freq
H.space2_freqtxt = uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[0 F.space_ht-F.tot_ht 125 F.ind_ht],...
   'String', 'center frequency (Hz):');
H.space2_freq = uicontrol('Style','edit',...
   'Units','pixels',...
...
F.tot_ht = F.tot_ht + F.ind_ht;
H.space2_NBstackpb = uicontrol('Style','pushbutton',...
   'Units','pixels',...
...
H.space2_bandwidth = uicontrol('Style','edit',...
   'Units','pixels',...
...
uicontrol('Style','text',...
   ...
   'String', 'ITD (us):');
H.space2_ITD = uicontrol('Style','edit',...
   'Units','pixels',...
...
uicontrol('Style','text',...
   ...
   'Position',[0 F.space_ht-F.tot_ht 80 F.ind_ht],...
   'String', 'Stim Dur (ms):');
H.space2_DUR = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[82 F.space_ht-F.tot_ht 60 F.ind_ht],...
...
%Hold ILD?
H.space2_ILDtxt = uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[165 F.space_ht-F.tot_ht 115 F.ind_ht],...
...
uicontrol('Style','text',...
   ...
   'String', 'El');
H.space2_el = uicontrol('Style','edit',...
   'Units','pixels',...
...
uicontrol('Style','text',...
   ...
   'String', 'Az');
H.space2_az = uicontrol('Style','edit',...
   'Units','pixels',...
...
uicontrol('Style','text',...
   ...
   'Position',[0 F.space_ht-F.tot_ht 80 F.ind_ht],...
   'String', 'ISI (ms):');
H.space2_ISI = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[82 F.space_ht-F.tot_ht 60 F.ind_ht],...
...
uicontrol('Style','text',...
   ...
   'Position',[0 F.space_ht-F.tot_ht 80 F.ind_ht],...
   'String', '# Reps:');
H.space2_numreps = uicontrol('Style','edit',...
   'Units','pixels',...
   'Position',[82 F.space_ht-F.tot_ht 60 F.ind_ht],...
...
if 0
    ...
    H.space2_buildOnly = uicontrol('Style','checkbox',...
        'Units','pixels',...
...
H.space2_inc_testnum = uicontrol('Style','pushbutton',...
   'Units','pixels',...
...
uicontrol('Style','text',...
   ...
   'String', 'Record Data?');
H.space2_recorddata = uicontrol('Style','checkbox',...
   'Units','pixels',...
...
H.exitspace = uicontrol('Style','togglebutton',...
   ...
   'FontWeight','bold',...
   'String', 'EXIT',...
   'Callback','Exit_space2');

%Status bar
F.tot_ht = F.tot_ht + F.ind_ht *2;
H.space2_status = uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[0 F.space_ht-F.tot_ht F.space_wd F.ind_ht],...
   'BackgroundColor','blue',...
   'ForegroundColor','white',...
...
H.space2_remreps = uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[102 F.space_ht-F.tot_ht 40 F.ind_ht],...
   'String', get(H.space2_numreps,'String'));
uicontrol('Style','text',...
   'Units','pixels',...
   'Position',[144 F.space_ht-F.tot_ht 60 F.ind_ht],...
   'String', 'Trials:');
H.space2_remtrials = uicontrol('Style','text',...
   'Units','pixels',...
...
F.ind_ht = 20; 
F.tot_ht = F.tot_ht + F.ind_ht *2;
H.space2_plotpsd = uicontrol('Style','togglebutton',...
   'Units','pixels',...
...
H.space2_plotwts = uicontrol('Style','togglebutton',...
   'Units','pixels',...
