...
%Independent variables:	ILD_dist(f), ild distance as a function of frequency
...
for cell_num = begin_cells:end_cells
   ...
   disp('Calculating unsigned distance matrix...')
   sign_flag = 0;
   ...
   stepwise(dist_ild',IA_meansurf',1:length(freq_bands),alpha);
   [b,bint,r,rint,tvals,stats] = regress(IA_meansurf',dist_ild',alpha);
