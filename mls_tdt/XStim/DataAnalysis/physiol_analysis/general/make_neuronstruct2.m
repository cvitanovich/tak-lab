...
if(tiftest ~= -1)
   ...
   if(Site.test{tiftest}.params.loc_flag == 1)
      ...
      [Neuron] = iftransform_4(Neuron,ILD_matrix(:,optlocnum),HRTFinfo,'tif');
   end
...
if(giftest ~= -1)
   ...
   if(Site.test{giftest}.params.loc_flag == 1)
      ...
      optlocnum = max(find(HRTFinfo.location_matrix(1,:) == azel(2) & ...
         HRTFinfo.location_matrix(2,:) == azel(1)));
      [Neuron] = iftransform_4(Neuron,ILD_matrix(:,optlocnum),HRTFinfo,'gif');
   end
...
if(tsiftest ~= -1)
   ...
   if(Site.test{tsiftest}.params.loc_flag == 1)
      ...
      optlocnum = max(find(HRTFinfo.location_matrix(1,:) == azel(2) & ...
         HRTFinfo.location_matrix(2,:) == azel(1)));
      [Neuron] = iftransform_4(Neuron,ILD_matrix(:,optlocnum),HRTFinfo,'tsif');
   end
...
if(gsiftest ~= -1)
   ...
   if(Site.test{gsiftest}.params.loc_flag == 1)
      ...
      optlocnum = max(find(HRTFinfo.location_matrix(1,:) == azel(2) & ...
         HRTFinfo.location_matrix(2,:) == azel(1)));
      [Neuron] = iftransform_4(Neuron,ILD_matrix(:,optlocnum),HRTFinfo,'gsif',...
...
if(bbiftest ~= -1)
   ...
   if(Site.test{bbiftest}.params.loc_flag == 1)
      ...
      optlocnum = max(find(HRTFinfo.location_matrix(1,:) == azel(2) & ...
         HRTFinfo.location_matrix(2,:) == azel(1)));
      [Neuron] = iftransform_4(Neuron,ILD_matrix(:,optlocnum),HRTFinfo,'bbif',...
         ILD_matrix_focus(:,IA_bestloc_ind));
   end
