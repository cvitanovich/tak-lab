function [locind, finalspikematrix, weights, IAresponse] = prep4_MLSweights(dataFN,dataPATH)
...
if isempty(locmax)
    [weights, IAresponse] = plot_MLSweights(finalspikematrix, locind);
else
    [weights, IAresponse] = plot_MLSweights(finalspikematrix, locind, locmax);
end
