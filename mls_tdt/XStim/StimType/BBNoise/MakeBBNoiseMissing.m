function [bbnoiseL,bbnoiseR] = MakeBBNoiseMissing(Fs,dur,targ_freq)
...
dur = dur/1000;
len = dur*Fs;
bandwidth = 1000; %bandwidth (Hz) of chunk for ILD adjustment
...
magR = magL;
magL(minfreq1:maxfreq1) = 0;
magR(minfreq1:maxfreq1) = 0;
