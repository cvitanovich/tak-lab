...
if get(H.recorddata,'Value')
    ...
    tempstr = [str0 str1 '   SPL1(' num2str(XStimParams.epoch_duration(1)) '):' num2str(10+XStimParams.source1_SPL) ...
            '  SPL2(' num2str(XStimParams.epoch_duration(2)) '):' num2str(10+XStimParams.focalSPL(1)) '-' num2str(10+XStimParams.focalSPL(2)) ...
            ' p = ' num2str(XStimParams.focalProb) '   atten: ' num2str(XStimParams.curr_ABL)];
...
while (exist1('H.Mc2Sourcefig') & (repnum <= XStimParams.numreps))
    ...
    while (exist1('H.Mc2Sourcefig') & (trialnum <= numtrials))
        ...
        t = toc-.1;
        %if trialnum > 1
            while t <= (DUR+ISI)/1000 t = toc-.1;    end
        %end        
        ...
        % save stims to disk with name of loc
