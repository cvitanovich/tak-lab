function fcoefs=make_ERBFiltA(Fs,cF)
% function [fcoefs]=make_ERBFilt1A(Fs,cF);
% This function computes the filter coefficients for one or more 
...
% cF is the center frequency (frequencies)
%
